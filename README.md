...
# University Rover Challenge 2018 – Requirements and Guidelines

Any issues not covered by these published rule sets will be addressed on a case-by-case basis by the University Rover Challenge (URC) irector. Please consult the Questions and Answers (Q&A) portion of the URC web site (http://urc.marssociety.org) for updates. All matters addressed in the Q&A are applicable to the requirements and guidelines.
